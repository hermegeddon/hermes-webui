    ...
    try:
        ...
        try:
            ...
            with _agent_lock:
                ...
                # A soft partial result with no concrete provider error can still
                # be a real turn when the transcript contains a final assistant
                # answer. Hard failures and tool-limit outcomes remain terminal.
                if (
                    _terminal_failure
